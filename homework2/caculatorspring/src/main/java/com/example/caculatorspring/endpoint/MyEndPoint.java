package com.example.caculatorspring.endpoint;
 ...
 */
@Endpoint(id = "caculator")
public class MyEndPoint {

    @ReadOperation
    public Map<String, String> hello() {
        Map<String, String> result = new HashMap<>();
        result.put("Project name", "caculator");
        result.put("Made by", "Mosen-Cao");
        result.put("Stud-id", "517030910256");
        return result;
    }
}